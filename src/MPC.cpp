...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        ...
        for (int t = 1; t < N; t++) {
            ...
            // The latency is equal to dt, so we just need to delay the actuators for 1 step
            // the first and second step are the same
            ...
            // delta0 is positive we rotate counter-clockwise, or turn left.
