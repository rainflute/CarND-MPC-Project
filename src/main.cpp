        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    //Assume the trajectyory start from where the car starts
                    ...
                    Eigen::Map<Eigen::VectorXd> ptsx_eig(&ptsx_car[0], ptsx.size());
                    Eigen::Map<Eigen::VectorXd> ptsy_eig(&ptsy_car[0], ptsy.size());
